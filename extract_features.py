...
from datasets_byol.dataset import get_dataset
from utils import calc_norm_stats
#tf.config.set_visible_devices([], 'GPU')

duration = 12
train_dataset,test_dataset = get_dataset('libri_100') #write the name of the task
...
def get_parser():
    ...
    parser.add_argument('--prefix', default='', type=str,
                        help='number of total epochs to run')
    parser.add_argument('--suffix', default='spec_byol' , type=str)
